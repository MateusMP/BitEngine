...
void Shader3DSimple::Shader3DSimpleGL4::BatchRendererGL4::addMesh(Mesh* mesh, BitEngine::Material* mat, const glm::mat4* modelMat) {
...
void Shader3DSimple::Shader3DSimpleGL4::BatchRendererGL4::Render() {
    ...
    for (Batch& b : batches)
    {
        ...
        for (const Batch& r : batches)
        {
            ...
            // Bind DIFFUSE
            auto material = ((Material3D*)r.material);
...
void Shader3DSimple::Shader3DSimpleGL4::BatchRendererGL4::createBatches()
{
    ...
    const BitEngine::Material* lastMaterial = nullptr;
    for (auto& it : data)
    {
...
void Shader3DSimple::Shader3DSimpleGL2::BatchRendererGL2::addMesh(Mesh* mesh, BitEngine::Material* mat, const glm::mat4* modelMat) {
    data[mesh].emplace_back(mat, modelMat);
}
