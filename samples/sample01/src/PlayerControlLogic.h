...
public:
    static BitEngine::EntityHandle CreatePlayerTemplate(BitEngine::ResourceLoader* loader, MyGameEntitySystem* es, BitEngine::CommandSystem* cmdSys)
    {
        ...
        gamelogic->addLogicPiece(new PlayerControl(cmdSys));
    ...
    PlayerControl(BitEngine::CommandSystem* cmdSys) :
        BitEngine::Messenger< BitEngine::CommandSystem::MsgCommandInput>::ScopedSubscription(cmdSys->commandSignal, &PlayerControl::onMessage, this)
    {}
