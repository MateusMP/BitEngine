...
namespace Reflection {
	...
	class ClassReflection
	{
                ...
                void addMemberVariable(const std::string& name, TypeId typeId, int offset)
		{
                ...
                MemberType* getMemberType(const std::string& name)
		{
